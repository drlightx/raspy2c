# raspy2c.py
#
# a (hopefully) comprehensive module for talking to and with i2c interfaced 
# devices. (Stefan Trotzky (tky42); 04/2017)
# --for reporting errors and a little support: stefan.trotzky@gmail.com
#
# Disclaimer: It is assumed that the user has a basic understanding of 
# electronics and takes common precautions against overvoltage/-current,
# static shock and other hazards in assembly and usage. 
#
# No responsibility for any damage of bus/microcontroller/processor/device 
# due to errors in the script provided here is taken by the developper. 
# They are unlikely (not impossible) anyways, but you hav been warned.
#
# Now go, play.
...
class DAC8574(I2c_device):
    ...
    def __init__(self,**kwargs):
        """ Initialize instance """
        raise NotImplementedError("Device support in developpment, \
        only move ahead if you know what you are doing!")
        I2c_device.__init__(self,**kwargs)
    ...
    def set_output(self,ch,value,units=None,load=0b01,units=None):
...
if __name__ == "__main__":
    # do some testing here (better: somewere else, importing this file.)
    
    # a quick example for the 9DOF sensor stick LSM9DS1
    ...
    meas_list = [adc,adc,adc,adc,acc,acc,acc,acc,acc,acc,acc]
    
    print("CTRL-C to abort.")
    # repeatedly measure and print to stdout
    while True:
